...
Gem::Specification.new do |s|
  s.name = "rack-lazy-load"
  s.version = "0.0.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Mika Tuupola"]
  s.date = "2012-01-22"
  s.description = "Make your website faster by deferring loading of images."
  ...
  s.homepage = "http://github.com/tuupola/rack-lazy-load"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.11"
  s.summary = "Companion middleware for jQuery Lazy Load"
